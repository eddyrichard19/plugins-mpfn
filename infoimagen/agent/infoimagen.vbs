...
If (fso.FileExists("C:\ProgramData\OCS Inventory NG\Agent\cacert.pem")) Then
cacert = "Cacert.pem - Ok"
Else
cacert = "Cacert.pem - Not Located"
End If
...
strLine7 = objTextFile.ReadLine
objTextFile.Close

writeXML WshNetwork.ComputerName,strLine1,strLine2,strLine3,strLine4,cacert,strLine5,strLine6,strLine7,mytime


Sub writeXML(Computername,Marca,Modelo,VersionIMAG,Sede,Cert,MSoffice,UpdateIMAG,RestoreIMAG,Dateplugin)
  Wscript.Echo _
  "<INFOIMAGEN>" & vbCrLf & _
